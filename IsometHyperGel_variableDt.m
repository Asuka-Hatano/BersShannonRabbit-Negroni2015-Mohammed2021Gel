function [Lneg,Fb,Qk,udot1] = IsometHyperGel_variableDt(TCatilde,TCastar,Tstar,X_w,X_p, dt,Qk,L,udot0)
...
function [E,eta] = setparameter(Nmaxwell)
% Mohammad paper viscoelastic parameters
zeta0 = 3.36224; 
sigma0 = 0.571;
tau0 = 0.0783; % [s]
G0   = 4.723;  % [kPa]
